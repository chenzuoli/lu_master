...
class HomeSwipperView extends StatefulWidget {
  HomeSwipperView({Key key}) : super(key: key);

  @override
  _HomeSwipperViewState createState() => _HomeSwipperViewState();
}

class _HomeSwipperViewState extends State<HomeSwipperView> {
