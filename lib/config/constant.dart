...
2.【本服务内容】本协议服务于”邻家宠物“APP，仅用于此APP。本协议内容同时包括电巴克可能不断发布的关于本服务的相关协议、业务规则等内容。内容一经正式发布，即为本服务不可分割的组成部分。
...
上海电巴克宠物服务有限公司
  """;
  static String privacy_content = """隐私保护协议

一、概述
本协议适用于所有使用“邻家宠物”APP（以下简称本软件）所提供的服务等相关事宜所订立的契约，请您仔细阅读本注册协议，您点击“我已阅读并同意《宠物摄影服务协议》“，本协议即构成对双方有约束力的法律文件。
...
3.如您已阅读并同意《宠物摄影服务协议》成功注册后，即可以享受邻家宠物宠物摄影服务。通过参与邻家宠物APP定期及不定期举行的活动，都将获得相应的积分奖励。您的参加的活动越多，达成目标越多，获得的积分值也将更多。积分不仅可以兑换邻家宠物礼品，还可以享受更多的会员服务。

三、隐私保护
1.保护用户隐私是本软件的一项基本义务。“隐私”是指用户在账号验证时提供给本软件的个人身份信息，包括用户提交的姓名、性别、联系方式、家庭住址、地理位置、证件号码，用户手机里面的相册、通讯录等等，以及验证通过后使用本软件后产生的服务等信息。本软件保证不对外公开或向第三方提供用户资料及用户在使用网络服务时存储在本软件的非公开内容，但下列情况除外：
（1）用户或用户监护人授权本软件披露的；
